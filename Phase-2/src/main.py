...
# t1 = task1.Task1(init_params)
# t1.reduce_dims('pca', 100)

# t2 = task2.Task2(init_params, t1.reduced_textual)
# s, o = t2.similarity('57503104@N00', 10, 'user')
# print(s, o)
# t2.similarity('10', 5, 'location', t1.user_data, t1.image_data, t1.location_data)
# t2.similarity('8524432176', 5, 'image', t1.user_data, t1.image_data, t1.location_data)

# t3 = task3.Task3(init_params, t1.visual_descriptors, t2.maps['image']['location'])
# t3.reduce('HOG', 'lda', 10)
# s_images, s_locations = t3.similarity('10482519424', 30)
# print(s_images)
# print(s_locations)

# t4 = task4.Task4(init_params, t1.visual_descriptors)
# t4.reduce('CM3x3', 'PCA', 6)
# s = t4.similarity('10', 30)
# print(s)

# t5 = task5.Task5(init_params, t1.visual_descriptors)
# ranks = t5.similarity(["CM", "CM3x3", "CN", "HOG", "LBP", "GLRLM"], "PCA", 5, '10', 30)
# print(ranks)

# t6 = task6.Task6(init_params)
# similarity_matrix = t6.similarity_matrix()
# reduced_similarity_matrix = t6.reduce(similarity_matrix, 20)
# print(reduced_similarity_matrix)

# t7 = task7.Task7(init_params)
